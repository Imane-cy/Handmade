...
// Requête pour récupérer tous les produits de la catégorie "Sacs"
$query = "
    SELECT id, nom, description, prix, image
    FROM produits
    WHERE categorie = 'Sacs'
";
...
<nav class="navbar navbar-expand-lg navbar-light shadow-sm">
  ...
  <section class="categories text-center">
    <div class="container">
      <h2 class="mb-5">Sacs - Sous-catégories</h2>
      <div class="row justify-content-center g-4">
        <div class="col-md-3">
          <a href="produits.php?cat=Sacs&sous=Totbag">
            <div class="category-circle">
              <img src="totbag.png" alt="Totbag" />
            </div>
            <div class="category-title">Totbag</div>
          </a>
        </div>
        <div class="col-md-3">
          <a href="produits.php?cat=Sacs&sous=Trousses">
            <div class="category-circle">
              <img src="trouse.png" alt="Trousses" />
            </div>
            <div class="category-title">Trousses</div>
          </a>
        </div>
        <div class="col-md-3">
          <a href="produits.php?cat=Sacs&sous=Sac Laptop">
            <div class="category-circle">
              <img src="sacL.png" alt="Sac Laptop" />
            </div>
            <div class="category-title">Sac Laptop</div>
          </a>
        </div>
        <div class="col-md-3">
          <a href="produits.php?cat=Sacs&sous=Sac au Cristal">
            <div class="category-circle">
              <img src="sacC.png" alt="Sac au Cristal" />
            </div>
            <div class="category-title">Sac au Cristal</div>
          </a>
        </div>
      </div>
    </div>
  ...
  <section class="container my-5">
    ...
    <div class="row g-4">
      <?php if ($result && $result->num_rows > 0): ?>
        ...
        <?php endwhile; ?>
      <?php else: ?>
        <p class="text-center">Aucun produit trouvé dans la catégorie Sacs.</p>
      <?php endif; ?>
    </div>
  </section>
